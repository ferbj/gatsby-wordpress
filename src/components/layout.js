...
const Layout = ({ children }) => (
  <div>
    <GlobalStyles />
    <body className="home page-template-default page page-id-6 wp-custom-logo fl-builder ast-desktop ast-page-builder-template ast-no-sidebar astra-1.8.2 ast-header-custom-item-inside group-blog ast-single-post ast-mobile-inherit-site-logo ast-inherit-site-logo-transparent ast-theme-transparent-header astra-addon-1.8.1 ast-mouse-clicked">
    <LayoutWrapper>
      <MainMenu />
      {children}
    </LayoutWrapper>
